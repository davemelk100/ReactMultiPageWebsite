      ...
      <div className="container" id="content">
        <div className="row my-3">
          <div className="col-lg-12 mx-0 p-4 shadow-lg rounded">
            ...
            <div className="row my-2 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 text-card mb-3">
                <h3 className="mb-0">Front End Design</h3>
              </div>
              <div className="col-lg-12">
                <ul>
            ...
            <div className="row my-4 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 text-card mb-3">
                <h3 className="mb-0">User Experience Design</h3>
              </div>
              <div className="col-lg-12">
                <ul>
                  <li>Photoshop / Illustrator / Sketch </li>
            ...
            <div className="row my-4 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 text-card mb-3">
                <h3 className="mb-0">Package Management</h3>
              </div>
              <div className="col-lg-12">
                <ul>
                  <li>NPM</li>
            ...
            <div className="row my-4 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 text-card mb-3">
                <h3 className="mb-0">Development Tooling</h3>
              </div>
              <div className="col-lg-12">
                <ul>
            ...
            <div className="row my-4 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 text-card mb-3">
                <h3 className="mb-0">Methodologies and Disciplines</h3>
              </div>
              <div className="col-lg-12">
                <ul>
                  <li>
