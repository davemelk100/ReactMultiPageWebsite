...
function Samples() {
  ...
  const handleOpenNewWindow = () => {
      window.open("http://localhost:3000/rxapp/", "_blank", "noopener,noreferrer");
    };
              ...
              <div className="row my-2 mx-1 sample-row d-flex flex-row">
                <div className="col-lg-12 text-card p-0">
                  ...
                  <h3 className="h2 my-3 p-0">
                    Please note: There are many more samples I'm not able to
                    share per Non-disclosure and Confidentiality agreements.
                  </h3>
                </div>
                  ...
                  <div className="row my-2 mx-1 sample-row d-flex flex-row">
                    <div className="col-lg-12 d-flex p-0">
                      <ul className="list-unstyled mt-4">
                        ...
                        <li className="mb-1">
                        <a onClick={handleOpenNewWindow}>
                            Rx App Prototype
                          </a>
                        </li>
                        <li className="mb-1">
                          <a href={videoconf} download>
                    ...
                    <div className="col-lg-12 p-0">
                      ...
                      <ul className="mb-6">
                        <li className="mb-1">
                          Created responsive front end for an Angular
                          application using Bootstrap and significant custom
                          HTML and CSS.
                        </li>
                        <li className="mb-1">
                        ...
                        <li className="mb-1">
                          Built a living style guide / design system for
                          reference when project was initiated
                        </li>
                        <li className="mb-1">
                          Collaborated with design agency to ensure design
                    ...
                    <div className="col-lg-12 mt-5 py-3 d-flex flex-column">
                      ...
                      <ul className="mb-2 pt-0 pb-1 py-0">
                        <li className="mb-1">
                          ...
                          application created by Dewpoint in support of a
                          special project for the city of Lansing, MI
                        </li>
                        <li className="mb-1">
                    ...
                    <div className="col-lg-12 mt-5 py-3 d-flex flex-column">
                      ...
                      <ul className="mb-2 pt-0 pb-1 py-0">
                        ...
                        <li className="mb-1">
                          Collaborated with product owner to bring the app
                          vision to life
                        </li>
                        <li className="mb-1">
                    ...
                    <div className="col-lg-12">
                      <div className="row my-5 mx-1 pb-5 d-flex">
                        <div className="col-lg-12">
                          ...
                          <p>
                            This group listening app concept began organically
                            as a game played on road trips.
                          </p>
                          <p>
                    ...
                    <div className="row my-5 mx-1 pb-5 d-flex">
                      <div className="col-lg-12">
                        ...
                        <p>
                          These are annoted wireframes with color and
                          placeholder text.
                        </p>
                      </div>
                    ...
                    <div className="row my-5 mx-1 pb-5 d-flex">
                      <div className="col-lg-12">
                        ...
                        <p>
                          These are various cover art concepts and digital
                          assets.
                        </p>
                        <small>
                          <a href="https://dribbble.com/davemelk100">
                    ...
                    <div className="row my-5 mx-1 pb-5 d-flex">
                      <div className="col-lg-12">
                        ...
                        <p>
                          This a layout template created after multiple
                          iterations and testing with users.
                        </p>
                      </div>
                      <div className="col-lg-12 comp-cols">
                        <a
