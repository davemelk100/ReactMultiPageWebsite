            ...
            <div className="row my-2 mx-1 sample-row d-flex flex-row">
              <div className="col-lg-12 d-flex p-0">
                <ul className="list-unstyled mt-4">
                  ...
                  <li className="mb-1">
                    <a href="https://dribbble.com/davemelk100">Creative work</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="col-lg-12 p-0">
                ...
                <ul className="mb-6">
                  ...
                  <li className="mb-1">
                    Performed accessibility reviews and implemented technical
                  ...
                  <li className="mb-1">
                    Collaborated with design agency to ensure design systems are
              ...
              <div className="col-lg-12 mt-5 d-flex flex-column">
                ...
                <ul className="mb-2">
                  <li className="mb-1">
                    Extended the individual shopping design system using Angular
                  ...
                  <li className="mb-1">
                    Conducted heuristic evaluations of product to identify user
                    experience issues
                  </li>
                  <li className="mb-1">
              ...
              <div className="col-lg-12">
                <div className="row my-5 mx-1 pb-5 d-flex">
                  <div className="col-lg-12">
                    ...
                    <p>
                      This group listening app concept began organically as a
                      game played on road trips.
                    </p>
              ...
              <div className="row my-5 mx-1 pb-5 d-flex">
                <div className="col-lg-12">
                  ...
                  <p>
                    These are random lo-fi wireframes I've made over the years.
                  </p>
                </div>
              ...
              <div className="row my-5 mx-1 pb-5 d-flex">
                <div className="col-lg-12">
                  ...
                  <p>
                    This a layout template created after multiple iterations and
                    testing with users.
                  </p>
                </div>
                <div className="col-lg-12 comp-cols">
