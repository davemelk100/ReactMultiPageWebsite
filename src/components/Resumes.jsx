              ...
              <div className="col-lg-12 text-card">
                ...
                <section className="work-history">
                  ...
                  <article>
                    ...
                    <p><strong>Position: </strong> UX/UI Designer/Developer</p>
                    <p><strong>Duration: </strong> August 2020</p>
                    <ul>
                      <li>Created functional prototype using proto.io for mobile application</li>
                      <li>Collaborated with product owner to bring the app vision to life</li>
                      <li>Worked with product owner to build a user experience that will be the product's differentiator</li>
                      <li>Built demos to be presented to board members and financial backers</li>
                      <li>Converted the proto.io concept application to HTML/CSS/JS for handoff to app developers</li>
                    </ul>
                  </article>
