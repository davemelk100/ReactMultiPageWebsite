                ...
                <section className="work-history">
                  <article>
                    ...
                    <ul>
                      ...
                      <li>
                        Served as SME for accessibility, ensuring ADA / WCAG /
                      ...
                      <li>
                        Worked in a development role for HTML/CSS-related work
                        items.
                      </li>
                      <li>
                        Created numerous design systems and clickable prototypes
                        in Figma
                      </li>
                      <li>
                        Created the UX and design for a live phone call auditing
                        feature
                      </li>
                      <li>
                      ...
                      <li>
                        Created the UX and design for a call history feature
                      </li>
                      <li>
                        Created the UX and re-design for the live phone call
                        display
                      </li>
                      <li>
                      ...
                      <li>
                        Orchestrated product development needs alongside
                        engineering timing and capacity
                      </li>
                      <li>
                        Collaborated with product owners on multiple
                        applications
                      </li>
                      <li>
                        Redesigned mobile application layout on video call
                        application
                      </li>
                      ...
                      <li>
                        Designed, developed, coded, and deployed new common
                        headers for the product suite
                      </li>
                      <li>
                  ...
                  <article>
                    ...
                    <ul>
                      <li>
                        Led Agile development for a SaaS project (DDMI),
                        implementing SDLC and Agile processes.
                      </li>
                      <li>
                      ...
                      <li>
                        Provided consulting and integration expertise for
                        third-party software (Dewpoint/DDMI).
                      </li>
                      <li>
                        Established enterprise standards for
                        HTML/CSS/Accessibility for UI developers (DDMI).
                      </li>
                      <li>
                        Collaborated with sales on statements of work and mobile
                      ...
                      <li>
                        Ensured DDMI applications met ADA, branding, and
                        marketing standards, including WCAG and Section 508
                        compliance.
                      </li>
                      <li>
                        Gathered user feedback to wireframe and improve ideas
                        (Lansing BWL).
                      </li>
                      <li>
                      ...
                      <li>
                        Developed annotated wireframes and visual style guides
                        (ONU One, DDMI).
                      </li>
                      <li>
                        Built POCs for event registration app in React/Node, and
                        Angular/Node with Umbraco CMS (Dewpoint).
                      </li>
                      <li>
                  ...
                  <article>
                    ...
                    <ul>
                      ...
                      <li>
                        Created strategy and methodology for user experience and
                      ...
                      <li>
                        Collaborated with the corporate CIO and IT president on
                        strategic decisions.
                      </li>
                      <li>
                      ...
                      <li>
                        Worked in conjunction with web content strategist on
                        information architecture.
                      </li>
                      <li>
                        Worked with corporate communications to ensure proper
                        web messaging.
                      </li>
                    </ul>
                  </article>
                  ...
                  <article>
                    ...
                    <ul>
                      ...
                      <li>
                        Managed team of 30 across numerous project tracks.
                      </li>
                      <li>
                      ...
                      <li>
                        Consulted internal and external groups about responsive
                        and accessible front-end coding.
                      </li>
                      <li>
                      ...
                      <li>
                        Served as subject matter expert for all of UHG regarding
                        HTML/CSS development.
                      </li>
                      <li>
                        Created responsive design component framework from
                        scratch using HTML/CSS/AngularJS.
                      </li>
                      <li>
                        Led team of developers to deliver responsive web design
                        code for rapid project development.
                      </li>
                      <li>Led UX/UI/technical strategy sessions.</li>
                      <li>
                        Integrated development team and UX team to review
                        proposals for technical feasibility.
                      </li>
                      <li>
                        Conducted regular sessions to ensure UX principles
                        remained intact from concept to build.
                      </li>
                    </ul>
                  </article>
                  ...
                  <article>
                    ...
                    <ul>
                      ...
                      <li>
                        Performed significant maintenance on BCBSM.com and
                        MiBCN.com.
                      </li>
                      <li>
                        Developed a new BCBSM Foundation site, which won a
                        bronze Wilmer Shields Rich Award.
                      </li>
                      <li>
                        Created numerous intranet sites, including CEO Dan
                        Loepp's website.
                      </li>
                      <li>
                        Assembled a streaming video platform for CEO Dan Loepp's
                        media webcasts.
                      </li>
                      <li>Created numerous dynamic forms using ColdFusion.</li>
                      <li>Built dynamic websites using ColdFusion.</li>
                      <li>
                        Redesigned division website to improve navigation.
                      </li>
                      <li>Developed a new layout for online manuals.</li>
                      <li>Created interactive training guides.</li>
                      <li>
                        Developed a division sub-site for the new
                        BlueHealthConnection product.
                      </li>
                    </ul>
                  </article>
                  ...
                  <article>
                    ...
                    <ul>
                      <li>
                        Created Web-based, interactive training guides used on
                        the website.
                      </li>
                      <li>
                      ...
                      <li>
                        Created/designed help and training documentation and
                        training course for 2 vehicle scheduling apps.
                      </li>
                    </ul>
                  </article>
                  ...
                  <article>
                    ...
                    <ul>
                      <li>
                        Created and maintained general communications website
                        for GM Service Operations.
                      </li>
                      ...
                      <li>
                        Provided customers with baseline-versus-actual reports,
                        project status reports, and recommendations.
                      </li>
                      <li>
                        Created risk assessments and contingency plans for
                        service manual development deliverables.
                      </li>
                      <li>
